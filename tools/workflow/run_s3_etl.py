# Workflow script: run_s3_etl.py
# Required files / artifacts:
# - configs/s3_etl.yaml (reads bucket_name, prefix)
# - .env.s3 (AWS credentials: AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY) or environment variables
# - writes: data/artifacts/raw_documents.json

"""
Moved from tools/run_s3_etl.py into tools/workflow.
This module provides generate_raw_documents(out_dir, configs_path, env_file) which returns a list
of document dicts and writes data/artifacts/raw_documents.json.
"""
