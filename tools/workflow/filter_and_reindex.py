# Workflow helper: filter_and_reindex.py
# Required files / artifacts:
# - data/artifacts/raw_documents.json (input)
# - output/all_cleaned_summaries.json (optional input)
# - writes: data/artifacts/cleaned_documents.json

"""
Moved from tools/filter_and_reindex.py into tools/workflow.
Provides generate_cleaned_documents(raw_path, summaries_path, out_path) and a main() that
also triggers the feature-engineering pipeline when run as a script.
"""
